    ...
    return (
        <>
            <div className='register'>
                ...
                <a className='back' href='/login'><i class="fa-solid fa-arrow-left-long"></i> Retour</a>
                <div className="register-body">
                    <h2 className="register_mess">S'inscrire</h2>
                    <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                        <Form>
                            ...
                            <button type='submit' className="button is-danger">S'inscrire</button>
                        </Form>
                    </Formik>
                </div>
            </div>
